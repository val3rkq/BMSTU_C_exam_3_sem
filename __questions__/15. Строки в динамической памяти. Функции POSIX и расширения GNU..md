...
- Функция *sprintf* аналогична функции *printf*, за исключением того, что вывод производится в массив, указанный аргументов *buf*. Возвращается количество символов, занесённых в массив. Пользователь должен самостоятельно выделить достаточное количество памяти.
...
int asrintf(char *buf, const char *format, ...);
```
