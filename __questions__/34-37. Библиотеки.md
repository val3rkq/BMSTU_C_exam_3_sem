...
- Библиотеки. Динамические библиотеки. Позиционный и зависимый код. plt. Про Linux.
...
**`-fPIC`**: генерирует код, который может быть загружен в любое место памяти, что необходимо для динамических библиотек.
...
#### **Динамическая библиотека на С, приложение на Python. Модуль ctypes.**
...
#### **Позиционный и зависимый код. PLT. Про Linux.**
...
По умолчанию в Linux, в отличие от Windows, функции библиотеки доступны наружу.
Чтобы изменить видимость функций, используем.
