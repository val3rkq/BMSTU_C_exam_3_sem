...
#### **Динамическая библиотека на С, приложение на Python. Модуль расширения.**
...
static PyMethodDef methods[] = {
	// имя функции на Питон, имя самой функции, ..., строка документирования
	{"add", add_numbers, METH_VARARGS, "add"},
	{"multiply", multiply_numbers, METH_VARARGS, "mul"},
	// сигнал о том, что таблица методов заполнена
	{NULL, NULL, 0, NULL}
}
